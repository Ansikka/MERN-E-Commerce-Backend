...
The frontend of the application is built with ReactJS, Material UI, React-router-dom,ContextAPI. The source code for the frontend can be found at [https://github.com/Ansikka/MERN-E-Commerce-Frontend](https://github.com/Ansikka/MERN-E-Commerce-Frontend).
